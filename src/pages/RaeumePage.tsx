...
export default function RaeumePage() {
  ...
  return (
    <PageShell
      title="Raeume"
      subtitle={`${records.length} Raeume im System`}
      action={
            ...
            {filtered.length === 0 && (
              <TableRow>
                <TableCell colSpan={4} className="text-center py-16 text-muted-foreground">
                  {search ? 'Keine Ergebnisse gefunden.' : 'Noch keine Raeume. Jetzt hinzufügen!'}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
